...
public class CounterActivity extends AppCompatActivity {
    ...
    private Button doubleBtn; // define double button variable
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        doubleBtn = findViewById(R.id.counter_double_btn);
        ...
        /* when double btn is pressed, counter *= 2, reset number textview*/
