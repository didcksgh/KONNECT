...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //if you want action bar to be shown
        /*
        ...
        */
        ...
        //if you want action bar to be hidden
    ...
    void displayQuestionsRemaining(int remainingQuestions){
        Integer remaining = remainingQuestions;
        tvMainQuestionsRemainingCount.setText(remaining.toString());
    }
    ...
    void startNewGame() {
        ...
        for (int i = 0; i < 7; i++){
            Question removeQuestion = chooseNewQuestion();
